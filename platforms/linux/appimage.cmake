function(make_appimage)
	set(optional)
	set(args EXE NAME DIR_ICON ICON OUTPUT_NAME APP_VERSION APP_NAME APP_ARCH)
...
"
    ...
    # Signez l'AppDir avec appimagetool + gpg2 
    #execute_process(
    #  COMMAND "${AIT_PATH}" "${APPDIR}" "--sign"
    #  RESULT_VARIABLE SIGN_RESULT
    #)

    # Vérifiez le résultat de la signature
   # if (SIGN_RESULT EQUAL 0)
   #   message(STATUS "L'AppDir a été signé avec succès.")
   # else()
   #   message(FATAL_ERROR "La signature de l'AppDir a échoué avec le code d'erreur : ${SIGN_RESULT}")
   # endif()

    # Invoke AppImageTool pour creer l executable .AppImage a partir du AppDir
